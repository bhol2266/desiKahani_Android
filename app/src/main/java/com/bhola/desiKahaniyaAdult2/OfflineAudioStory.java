...
//NO BANNER AD IN STORY LIST
    ...
    private void loadSavedAudioFiles() {
        ...
        for (int i = 0; i < name_array.size(); i++) {
            com.bhola.desiKahaniyaAdult2.AudioOfflineModel model = new com.bhola.desiKahaniyaAdult2.AudioOfflineModel(name_array.get(i), path_array.get(i));
...
class OfflineAudioAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        com.bhola.desiKahaniyaAdult2.AudioOfflineModel model = (com.bhola.desiKahaniyaAdult2.AudioOfflineModel) collectionData.get(holder.getAdapterPosition());
