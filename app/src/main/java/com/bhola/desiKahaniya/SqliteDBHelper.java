...
public class SqliteDBHelper extends SQLiteOpenHelper {
    ...
    public SqliteDBHelper(@Nullable Context mcontext, String name, int version, String Database_tableName) {
...
//            db_delete();
    ...
    private void checkandUpdateLoginTimes_UpdateDatabaseCheck() {
        ...
        Cursor cursor1 = new SqliteDBHelper(context, SplashScreen.DB_NAME, SplashScreen.DB_VERSION, "DB_VERSION").read_DB_VERSION();
        while (cursor1.moveToNext()) {
            int DB_VERSION_FROM_DATABASE = cursor1.getInt(1);

            if (DB_VERSION_FROM_DATABASE != SplashScreen.DB_VERSION_INSIDE_TABLE) {
                SqliteDBHelper databaseHelper2 = new SqliteDBHelper(context, SplashScreen.DB_NAME, SplashScreen.DB_VERSION, "DB_VERSION");
